...
esttab using otherplacebo.csv, replace keep(1.treat 1.post 1.treat#1.post 1.lowinc 1.lowinc#1.treat 1.lowinc#1.post 1.lowinc#1.treat#1.post)  b(3) se(3)
...
esttab using 3d_placebo.csv, replace keep(1.treat 1.post 1.treat#1.post 1.lowinc 1.lowinc#1.treat 1.lowinc#1.post 1.lowinc#1.treat#1.post) sca(coef p1) b(3) se(3)
