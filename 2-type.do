...
esttab using 3dtype_`i'.csv, replace keep(1.treat 1.post 1.treat#1.post 1.lowinc 1.lowinc#1.treat 1.lowinc#1.post 1.lowinc#1.treat#1.post) sca(coef p1) b(3) se(3)
